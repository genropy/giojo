...
├── dojo_libs/
│   └── giojo/
│       ├── dojo     -> ../../src   # Symlink ai sorgenti Giojo (compilato)
│       └── dojo_src -> ../../src   # Symlink ai sorgenti Giojo (sorgente)
├── gnrjs/
...
```bash
source /Users/gporcari/Sviluppo/giojo/genropy_env/.venv/bin/activate
```
